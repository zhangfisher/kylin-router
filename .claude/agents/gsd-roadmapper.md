...
Reference full template: `C:/Work/Code/kylin-router/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Work/Code/kylin-router/.claude/get-shit-done/templates/state.md`.

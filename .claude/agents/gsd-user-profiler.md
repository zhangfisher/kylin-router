...
<reference>
@C:/Work/Code/kylin-router/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Work/Code/kylin-router/.claude/get-shit-done/references/user-profiling.md` to load:

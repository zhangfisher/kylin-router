...
Intel system is disabled. To activate:
  ...
  node C:/Work/Code/kylin-router/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node C:/Work/Code/kylin-router/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node C:/Work/Code/kylin-router/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node C:/Work/Code/kylin-router/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: C:/Work/Code/kylin-router/.claude/get-shit-done/bin/gsd-tools.cjs

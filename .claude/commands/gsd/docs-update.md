...
<execution_context>
@C:/Work/Code/kylin-router/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @C:/Work/Code/kylin-router/.claude/get-shit-done/workflows/docs-update.md end-to-end.

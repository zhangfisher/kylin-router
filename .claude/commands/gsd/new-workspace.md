...
<execution_context>
@C:/Work/Code/kylin-router/.claude/get-shit-done/workflows/new-workspace.md
@C:/Work/Code/kylin-router/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @C:/Work/Code/kylin-router/.claude/get-shit-done/workflows/new-workspace.md end-to-end.

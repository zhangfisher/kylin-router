...
<!-- For checkpoint task examples and patterns, see @C:/Work/Code/kylin-router/.trae/get-shit-done/references/checkpoints.md -->
...
See `C:/Work/Code/kylin-router/.trae/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Work/Code/kylin-router/.trae/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Work/Code/kylin-router/.trae/get-shit-done/workflows/verify-phase.md` for verification logic.

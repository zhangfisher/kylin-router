...
- Usage: Reference from command with `@C:/Work/Code/kylin-router/.trae/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Work/Code/kylin-router/.trae/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Work/Code/kylin-router/.trae/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

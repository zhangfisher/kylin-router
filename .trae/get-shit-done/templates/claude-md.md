...
Template for project-root `.trae/rules/` — auto-generated by `gsd-tools generate-claude-md`.
...
**Discovery behavior:**
- Scans `.trae/skills/`, `.agents/skills/`, `.cursor/skills/`, `.github/skills/` for subdirectories containing `SKILL.md`
...
.trae/rules/ file and no profile section exists yet.

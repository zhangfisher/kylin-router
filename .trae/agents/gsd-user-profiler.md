...
<reference>
@C:/Work/Code/kylin-router/.trae/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Work/Code/kylin-router/.trae/get-shit-done/references/user-profiling.md` to load:

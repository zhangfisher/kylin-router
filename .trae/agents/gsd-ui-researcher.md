...
Use template from `C:/Work/Code/kylin-router/.trae/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Work/Code/kylin-router/.trae/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Work/Code/kylin-router/.trae/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```

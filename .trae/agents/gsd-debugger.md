...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Work/Code/kylin-router/.trae
                  → checks C:/Work/Code/kylin-router/.trae/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Work/Code/kylin-router/.trae/get-shit-done
                  → writes to C:/Work/Code/kylin-router/.trae/get-shit-done/hooks/
...
@C:/Work/Code/kylin-router/.trae/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Work/Code/kylin-router/.trae/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/Work/Code/kylin-router/.trae/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Work/Code/kylin-router/.trae/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Work/Code/kylin-router/.trae/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

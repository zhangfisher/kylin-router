...
describe("normalizeRoutes - 默认路由处理", () => {
    it('应该将子路由中的默认路由（path=""）合并到父路由中', () => {
        const input: KylinRouteItem[] = [
            {
                path: "a",
                view: "parent.html",
                children: [{ path: "", name: "default", cache: 1, children: [{ path: "x" }] }],
            },
        ];
        const output = normalizeRoutes(input);
        ...
        const input: KylinRouteItem[] = [
            {
                path: "b",
                view: "parent.html",
                children: [{ path: "/", title: "Default Title", children: [{ path: "y" }] }],
            },
        ];
        const output = normalizeRoutes(input);
        ...
        const input: KylinRouteItem[] = [
            {
                ...
                children: [
                    {
                        path: "b",
                        children: [{ path: "", name: "nested-default", view: "default.html" }],
                    },
                ],
            },
        ];
    ...
    it("应该在默认路由没有children时正确移除它", () => {
        const input: KylinRouteItem[] = [
            {
                path: "c",
                children: [
                    { path: "", name: "no-children-default" },
                    { path: "other", view: "other.html" },
                ],
            },
        ];
        const output = normalizeRoutes(input);
        ...
        expect(output).toMatchObject({
            ...
            children: [
                {
                    path: "c",
                    name: "no-children-default",
                    children: [{ path: "other", view: "other.html" }],
                },
            ],
        });
    });
    ...
    it("应该处理根路由下的默认路由", () => {
        const input: KylinRouteItem[] = [
            {
                path: "/",
                children: [
                    { path: "", name: "root-default", view: "home.html" },
                    { path: "about", view: "about.html" },
                ],
            },
        ];
        ...
        expect(output).toMatchObject({
            ...
            name: "root-default",
            view: "home.html",
            children: [{ path: "about", view: "about.html" }],
        });
    });
});

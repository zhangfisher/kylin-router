...
export type RenderEachHook = (
    to: RouteItem,
    from: RouteItem,
    next: (data?: RouteDataSource) => void,
    router: any,
) => void | Promise<void> | RouteDataSource | Promise<RouteDataSource>;
 ...
 */
export type RouteDataSource =string | Record<string, any> | (() => Record<string, any> | Promise<Record<string, any>>);

...
#### 核心路由功能
- [ ] **路由表定义与匹配** - 支持 path、component、children 等配置
- [ ] **动态路由参数** - 支持 `/user/:id` 模式和参数解析
- [ ] **嵌套路由** - 支持多层路由嵌套和路径继承
- [ ] **路由守卫** - beforeEach、beforeResolve、afterEach 钩子
- [ ] **编程式导航** - push、replace、back、forward 方法
